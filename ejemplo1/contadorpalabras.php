    ...
    <section>
        <article class="container">
            ...
            if(isset($_POST['btnContar'])):
                //Se carga la librería con la función que se encargar de contar las palabras en el texto ingresado por el usuario
            ...
            ?>
            <form action = "<?php echo $_SERVER['PHP_SELF']; ?>" method ="POST" name = "frmtexto" id="frmltexto" class="col s12">
